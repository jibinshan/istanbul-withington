          ...
          getFilteredMenuItems({
            ...
            return (
              <section
                key={data._id}
                id={data._id}
                className={cn("mt-6 flex w-full flex-col gap-2 lg:mt-0", data._id !== existCategory.find((categoryid) => categoryid === data._id) && "hidden mt-0 w-0 gap-0")}
              >
                <h1
                  id={data._id}
                  className={cn(
                ...
                >
                  {data._id === existCategory.find((categoryid) => categoryid === data._id) && data.categoryName}
                </h1>
